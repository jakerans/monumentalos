...
const CATEGORY_COLORS = {
  ...
  distribution: 'bg-emerald-100 text-emerald-700', processing_fee: 'bg-pink-100 text-pink-700',
  other: 'bg-gray-100 text-gray-700',
};
const TYPE_COLORS = { uncategorized: 'bg-yellow-100 text-yellow-700', cogs: 'bg-orange-100 text-orange-700', overhead: 'bg-gray-100 text-gray-700', distribution: 'bg-emerald-100 text-emerald-700' };
