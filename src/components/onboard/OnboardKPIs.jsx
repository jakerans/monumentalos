...
export default function OnboardKPIs({ projects, tasks }) {
  ...
  const cards = [
    { label: 'Active Projects', value: stats.activeCount, icon: PlayCircle, color: 'text-blue-600', bg: 'bg-blue-50' },
    { label: 'Completed', value: stats.completedCount, icon: CheckCircle, color: 'text-green-600', bg: 'bg-green-50' },
    { label: 'Avg Days to Launch', value: stats.avgDays ?? '—', sub: 'Last 90 days', icon: Clock, color: 'text-amber-600', bg: 'bg-amber-50' },
    { label: 'Open Tasks', value: stats.pendingTaskCount, icon: BarChart3, color: 'text-indigo-600', bg: 'bg-indigo-50' },
  ];
