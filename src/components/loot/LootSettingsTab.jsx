      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mb-2">Chance of a loot box dropping on any single booking</p>
            <Input
              type="number"
        ...
        <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mb-2">Maximum unopened loot boxes a setter can hold</p>
            <Input
              type="number"
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mb-2">Loot box count that triggers yellow warning badge</p>
            <Input
              type="number"
        ...
        {/* Box Images */}
        <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-6 space-y-4">
          <h3 className="text-white font-bold mb-4">Loot Box Images</h3>
