  ...
  return (
    <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-4 flex flex-col h-full">
      <div className="flex items-center gap-2 mb-3">
        ...
        <InfoTooltip text="Shows where your revenue is coming from this month — which billing types (retainer, pay-per-set, pay-per-show, hybrid) are generating the most money. Useful for seeing how dependent you are on any one model." />
      </div>

      {totalRevenue === 0 ? (
        <p className="text-xs text-slate-500 text-center py-8 flex-1 flex items-center justify-center">No revenue data yet this month</p>
      ) : (
