  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed left-0 bottom-4 sm:bottom-auto sm:top-[38%] sm:-translate-y-1/2 z-40 flex items-center gap-2 sm:gap-3 pl-3 sm:pl-4 pr-3 sm:pr-5 py-3 sm:py-4 rounded-r-2xl border border-l-0 overflow-hidden bg-slate-800 ${rankConfig.border} ${!isTop3 ? 'hover:bg-slate-700' : ''}`}
